...
function NameCard({ onClick }) {
    ...
    return (
        <div ref={myRef} className="absolute left-[8%] top-[2%] w-[15vw] cursor-pointer group must-click" onClick={() => onClick(getClickOrigin("namecard", myRef, onClick))}>
            <div className="desk-object bg-white flex flex-row items-center gap-2 p-2 h-[8vw]">
